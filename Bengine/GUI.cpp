...
void Bengine::GUI::notifyDisplaySizeChanged(float screenWidth, float screenHeight)
{
    CEGUI::System::getSingleton().notifyDisplaySizeChanged(CEGUI::Sizef(screenWidth, screenHeight));
}
